...
<section class="section" style="text-align: center;">
    ...
    <!-- وضع الصورة في منتصف الصفحة لتنسيق أفضل -->
    <div style="text-align: center; margin-bottom: 30px;">
        <img src="../img/confirm.jpg" style="max-width: 200px; border-radius: 50%;">
    </div>

    <h3> Orders Item List </h3>
    <hr>
    ...
    <div class="products">
        ...
        WHERE orders.id = (SELECT MAX(id) FROM orders WHERE user_id = $userId)
...
<br>
<br>
                                 <a href="orders.php" class="form-button">Check all your orders</a>
